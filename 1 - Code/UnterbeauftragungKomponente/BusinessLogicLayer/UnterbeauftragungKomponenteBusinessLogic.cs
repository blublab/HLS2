...
namespace ApplicationCore.UnterbeauftragungKomponente.BusinessLogicLayer
{
    ...
    internal class UnterbeauftragungKomponenteBusinessLogic
    {
        ...
        public int BeaufrageTransport(FrachtfuehrerRahmenvertrag frv, DateTime planStartzeit, DateTime planEndezeit, int verwendeteKapazitaetTEU, int verwendeteKapazitaetFEU)
        {
